...
const DemographicQuestions: React.FC = () => {
  ...
  return (
    <div>
      {showConsentModal && <ConsentModal onAccept={handleAccept} onDeny={handleDeny} />}
      {!showConsentModal && (
          ...
          <div className="flex flex-col justify-center px-16 w-full border-0 border-solid leading-[150%] max-md:px-5 max-md:max-w-full" style={{ borderColor: 'rgb(34, 72, 73)' }}>
            <div className="flex justify-center items-center px-16 max-md:px-5 max-md:mr-1 max-md:max-w-full">
              <div className="flex gap-5 justify-between w-full max-w-[1089px] max-md:flex-wrap max-md:max-w-full">
                ...
                <div onClick={() => router.push('/demographicquestions')} className="justify-center px-8 py-3 my-auto text-lg font-semibold rounded-[500px] text-slate-950 max-md:px-5" style={{ backgroundColor: 'rgb(212, 114, 62)', cursor: 'pointer' }}>
                    ...
                    <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                      <div className="flex flex-col w-[55%] max-md:ml-0 max-md:w-full">
                        <div className="flex flex-col grow pb-3.5 text-sm leading-5 text-gray-800 max-md:mt-10">
                          ...
                          <div className="mt-11 max-md:mt-10" onClick={() => router.push('/demographicquestions')} style={{ cursor: 'pointer' }}>{selectedContent.playMat}</div>
