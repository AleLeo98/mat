...
import { faMusic, faBook, faPaintBrush } from '@fortawesome/free-solid-svg-icons';
...
function MemCard4() {
  ...
  const content = {
    EN: {
      ...
      childDetails: [
        "I am diligent and careful in my studies. I am quiet and reserved. I am imaginative and creative.",
        "I am nine years old.",
        "Music",
        "Books",
        "Art"
      ],
      cardsToGo: '2 cards to go'
    },
    IT: {
      playMat: 'Gioca a MAT',
      about: 'Chi siamo',
      ...
      childDetails: [
        "Ho molta diligenza e attenzione nei confronti degli studi. Ho un carattere tranquillo e riservato. Ho molta fantasia e creatività.",
        "Ho nove anni",
        "Musica",
        "Libri",
        "Arte"
      ],
      cardsToGo: '2 carte rimanenti'
    }
  };
      ...
      <div className="flex flex-col self-center px-5 mt-24 w-full font-bold text-gray-800 max-w-[1240px] max-md:mt-10 max-md:max-w-full">
        ...
        <div className="flex flex-col py-16 mt-16 rounded-[30px] max-md:mt-10 max-md:max-w-full" style={{ backgroundColor: 'rgb(34, 72, 73)' }}>
              ...
              <div className="flex gap-5 justify-center max-md:flex-col max-md:gap-0">
                ...
                <div className="flex flex-col ml-8 w-[60%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col grow items-start py-7 pr-14 pl-6 mx-auto w-full text-lg leading-7 bg-white rounded-3xl max-md:px-5 max-md:mt-10" style={{ backgroundColor: 'rgb(251, 238, 239)' }}>
                    ...
                    <div className="flex gap-3 mt-3.5">
                      <div className="flex justify-center items-center font-bold text-black bg-orange-400 rounded-md h-[35px] w-[35px] text-lg">
                        <FontAwesomeIcon icon={faPaintBrush} className="text-2xl" />
                      </div>
                      <div className="flex-auto my-auto font-medium text-gray-800">
          ...
          <div className="flex flex-col justify-center items-start mt-7 bg-white max-md:pr-5 max-md:max-w-full">
            <div className="shrink-0 h-3.5 bg-orange-400 w-4/6" />
          </div>
        </div>
