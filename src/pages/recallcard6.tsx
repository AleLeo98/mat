...
function RecallCard6() {
  ...
  const content = {
    EN: {
      ...
      age: 'Age',
      child1: 'Child 6',
      child1Description: 'I am easily bored. I am sensitive. I have the record for broken bike wheels.',
    ...
    IT: {
      ...
      age: 'Età',
      child1: 'Carta 6',
      child1Description: 'Mi annoio facilmente. Sono sensibile. Ho il record di ruote di bici rotte.',
