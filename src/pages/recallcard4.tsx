...
function RecallCard4() {
  ...
  const content = {
    EN: {
      ...
      recallInstructionDetail: 'Select all icons that apply to each child. For some options, you may need to select more than one icon. If the information was not present, click the icon with the slash.',
      ...
      age: 'Age',
      child1: 'Child 4',
      child1Description: 'I am diligent and careful in my studies. I am quiet and reserved. I am imaginative and creative.',
    ...
    IT: {
      ...
      recallInstructionDetail: "Seleziona tutte le icone che si applicano a ciascun bambino. Per alcune opzioni, potrebbe essere necessario selezionare più di un'icona. Se l'informazione non era presente, clicca sull'icona con la barra.",
      ...
      age: 'Età',
      child1: 'Carta 4',
      child1Description: 'Ho molta diligenza e attenzione nei confronti degli studi. Ho un carattere tranquillo e riservato. Ho molta fantasia e creatività.',
      ...
      <div className="flex flex-col self-center px-5 mt-24 w-full font-bold text-gray-800 max-w-[1240px] max-md:mt-10 max-md:max-w-full">
        ...
        <div className="flex flex-col py-16 mt-16 rounded-[30px] max-md:mt-10 max-md:max-w-full" style={{ backgroundColor: 'rgb(34, 72, 73)' }}>
          ...
          <div className="flex flex-col justify-center items-start mt-7 bg-red-50 max-md:pr-5 max-md:max-w-full">
            <div className="shrink-0 max-w-full h-3.5 bg-orange-400 w-4/6" />
          </div>
        </div>
